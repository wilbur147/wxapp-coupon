...
const getUserLocation = () => {
    wx.getLocation({
      ...
      success: (res) => {
        ...
        qqmapsdk.reverseGeocoder({
          ...
          success: (res) => {
            ...
            app.globalData.userLocation = { ...cityInfo}   //浅拷贝对象
            app.globalData.selectCity = { ...cityInfo } //浅拷贝对象
            // 由于 getUserInfo 是网络请求，可能会在 Page.onLoad 之后才返回，所以此处加入 callback 以防止这种情况
            if (app.userLocationReadyCallback) {
      ...
      fail:()=>{
        app.globalData.userLocation = {status:0}
        //防止当弹框出现后，用户长时间不选择，
        if (app.userLocationReadyCallback) {
          app.userLocationReadyCallback()
        }
